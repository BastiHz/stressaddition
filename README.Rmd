...
Calculate the LC<sub>50</sub> under the influence of toxicant and system stress and the LC<sub>10</sub> under the influence  of toxicant, environmental and system stress:
```{r}
